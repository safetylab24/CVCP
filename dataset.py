...
def get_data(
    ...
    **dataset_kwargs
    ...
    return [NuScenesGeneratedDataset(scene_name, cvt_metadata_path, bbox_label_path) for scene_name in split_scenes]
...
class NuScenesGeneratedDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, scene_name, cvt_metadata_path, bbox_label_path):
...
def get_train_dataloader(dataset_dir=None, cvt_metadata_path=None, bbox_label_path=None, version='v1.0-trainval', batch_size=1, num_workers=1, num_classes=2):
    datasets = get_data(
